...
/** Interface of persistent server state. Current term, latest node vote and all log entries must be committed here to
 *  stable storage before responding to RPC. For more info, look at Figure 2 of https://raft.github.io/raft.pdf
 */
trait Storage {
  def log: Log
